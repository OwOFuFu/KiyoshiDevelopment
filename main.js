...
function playpause() {
  ...
  function visualmode(){
    ...
    document.querySelector('.portfolio-heading-article').classList.toggle('heading-article-light');
    document.querySelector('.portfolioHeadingP').classList.toggle('heading-article-light');
    ...
    document.querySelector('.plugins-heading-article').classList.toggle('heading-article-light');
    document.querySelector('.pluginsHeadingP').classList.toggle('heading-article-light');
    ...
    let pluginsBox = document.querySelectorAll('.plugins-box');
    pluginsBox.forEach(Box => {
